...
- **NEW: Advanced LED configuration menu fully functional** ([see screenshots below](#led-configuration-screenshots)).  
...
- **CPU Load and Temperature:** Added monitoring widgets in LuCI (see [below](#cpu-load-and-temperature-monitoring)).
- Extra configuration:  
...
- Advanced LED and port management (see [screenshots](#led-configuration-screenshots))
...
¡Gracias por todo el trabajo realizado hasta ahora—aún queda mucho por hacer y muchas ideas por delante!# xgs-pont-2 (OpenWrt Kernel 6.6.100)
