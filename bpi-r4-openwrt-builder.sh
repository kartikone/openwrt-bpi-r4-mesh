...
git clone --branch openwrt-24.10 https://github.com/brudalevante/openwrt-18-08-25-espejo.git openwrt || true
...
git clone --depth=1 --single-branch --branch main https://github.com/brudalevante/fakemesh-18-8-25.git tmp_comxwrt
